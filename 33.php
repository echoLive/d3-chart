...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="33.php" class="btn btn-primary btn-xs" role="button">GF</a>        
...
<?php include 'curl_investing.php';
                        $gf_last = scrape_between($scraped_page, "pid-961618-last", "</td>");
                        $gf_change_per = scrape_between($scraped_page, "pid-961618-pcp", "</td>");
                        $gf_last = substr($gf_last, 2);
                        $gf_change_per = substr($gf_change_per, 3);
                        echo $gf_last; ?>                     
                        <span style="color: <?php echo ($gf_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $gf_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
