...
<html>                             
    ...
    <body>                      
        <div id="navbox">        
            <a href="10.php" class="btn btn-primary btn-xs" role="button">GC</a>        
        ...
        <div id="demobox">        
            <div id="csbox">            
                ...
                <div id="infobar">                
                    ...
                    <div>Today:
                    <?php
                        include 'curl_investing.php';
                        $gc_last = scrape_between($scraped_page, "pid-8830-last", "</td>");
                        $gc_change_per = scrape_between($scraped_page, "pid-8830-pcp", "</td>");
                        $gc_last = substr($gc_last, 2);
                        $gc_change_per = substr($gc_change_per, 3);
                        echo $gc_last; ?>

                        <span style="color: <?php echo ($gc_change_per < 0 ? 'red' : 'green') ?>">&nbsp;                                         
                        <?php echo $gc_change_per; ?>                         
                        </span>                 
                    </div>
                </div>
                <div id="chart1"><p>Gold</p>
                </div>  
            </div>            
        </div>                                    
        <div id="cotbox">                 
