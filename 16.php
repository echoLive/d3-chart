...
<html>
    <head>    
        ...
        <title>Gasoline Blendstock RBOB
        </title>    
...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="16.php" class="btn btn-primary btn-xs" role="button">RB</a>        
...
<?php include 'curl_investing.php';
                    $rb_last = scrape_between($scraped_page, "pid-954867-last", "</td>");
                    $rb_change_per = scrape_between($scraped_page, "pid-954867-pcp", "</td>");
                    $rb_last = substr($rb_last, 2);
                    $rb_change_per = substr($rb_change_per, 3);
                    echo $rb_last;
                                            ?>                     
                        <span style="color: <?php echo ($rb_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $rb_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
