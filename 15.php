...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="15.php" class="btn btn-primary btn-xs" role="button">CL</a>        
...
<?php include 'curl_investing.php';
                    $cl_last = scrape_between($scraped_page, "pid-8849-last", "</td>");
                    $cl_change_per = scrape_between($scraped_page, "pid-8849-pcp", "</td>");
                    $cl_last = substr($cl_last, 2);
                    $cl_change_per = substr($cl_change_per, 3);
                    echo $cl_last;
                        ?>                     
                        <span style="color: <?php echo ($cl_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $cl_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
