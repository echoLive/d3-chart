...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="27.php" class="btn btn-primary btn-xs" role="button">CT</a>        
...
<?php include 'curl_investing.php';
                        $ct_last = scrape_between($scraped_page, "pid-8851-last", "</td>");
                        $ct_change_per = scrape_between($scraped_page, "pid-8851-pcp", "</td>");
                        $ct_last = substr($ct_last, 2);
                        $ct_change_per = substr($ct_change_per, 3);
                        echo $ct_last; ?>                     
                        <span style="color: <?php echo ($ct_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $ct_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
