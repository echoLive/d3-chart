...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="18.php" class="btn btn-primary btn-xs" role="button">NG</a>        
...
<?php include 'curl_investing.php'; 
                    $ng_last = scrape_between($scraped_page, "pid-8862-last", "</td>");
                    $ng_change_per = scrape_between($scraped_page, "pid-8862-pcp", "</td>");
                    $ng_last = substr($ng_last, 2);
                    $ng_change_per = substr($ng_change_per, 3);
                    echo $ng_last;
                                            ?>                     
                        <span style="color: <?php echo ($ng_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $ng_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
