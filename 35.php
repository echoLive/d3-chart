...
<script src="csmain2.js"></script>     
    ...
    <body>             
        <div id="navbox">                     
            ...
            <a href="35.php" class="btn btn-primary btn-xs" role="button">DA</a>             
        </div>             
        <div id="demobox">                     
            <div id="csbox">                             
                <div id="option">                                     
...
<?php include 'curl_investing.php';
                        $da_last = scrape_between($scraped_page, "961735-last", "</td>");
                        $da_change_per = scrape_between($scraped_page, "961735-pcp", "</td>");
                        $da_last = substr($da_last, 2);
                        $da_change_per = substr($da_change_per, 3);
                        echo $da_last; ?>                                               
                        <span style="color: <?php echo ($da_change_per < 0 ? 'red' : 'green') ?>">&nbsp;                             
                            <?php echo $da_change_per; ?>                                                                                             
                        </span>                      
                    </div>                             
                </div>                                 
                <div id="chart1">                                                                                            
