...
<script src="csmain2.js"></script>       
    ...
    <body>             
        <div id="navbox">                     
            ...
            <a href="14.php" class="btn btn-primary btn-xs" role="button">HG</a>                     
...
<?php include 'curl_investing.php';
                    $hg_last = scrape_between($scraped_page, "pid-8831-last", "</td>");
                    $hg_change_per = scrape_between($scraped_page, "pid-8831-pcp", "</td>");
                    $hg_last = substr($hg_last, 2);
                    $hg_change_per = substr($hg_change_per, 3);
                    echo $hg_last; ?>                                               
                        <span style="color: <?php echo ($hg_change_per < 0 ? 'red' : 'green') ?>">&nbsp;                             
                            <?php echo $hg_change_per; ?>                         
                        </span>                                     
                    </div>                             
                </div>                             
