...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="22.php" class="btn btn-primary btn-xs" role="button">ZO</a>        
        ...
        <div id="demobox">        
            <div id="csbox">            
                ...
                <div id="infobar">                
                    ...
                    <div class="infointraday">Today:                 
<?php include 'curl_investing.php';
                $zo_last = scrape_between($scraped_page, "pid-959199-last", "</td>");
                $zo_change_per = scrape_between($scraped_page, "pid-959199-pcp", "</td>");
                $zo_last = substr($zo_last, 2);
                $zo_change_per = substr($zo_change_per, 3);
                echo $zo_last;
                                        ?>                 
                        <span style="color: <?php echo ($zo_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $zo_change_per; ?>
                        </span>            
                    </div>            
                </div>                
                <div id="chart1">                                                                           
