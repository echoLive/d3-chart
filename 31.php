...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="31.php" class="btn btn-primary btn-xs" role="button">LB</a>        
...
<?php include 'curl_investing.php';
                        $lb_last = scrape_between($scraped_page, "pid-959198-last", "</td>");
                        $lb_change_per = scrape_between($scraped_page, "pid-959198-pcp", "</td>");
                        $lb_last = substr($lb_last, 2);
                        $lb_change_per = substr($lb_change_per, 3);
                        echo $lb_last; ?>                     
                        <span style="color: <?php echo ($lb_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $lb_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
