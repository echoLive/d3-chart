...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="25.php" class="btn btn-primary btn-xs" role="button">ZL</a>        
...
<?php include 'curl_investing.php';
                        $zl_last = scrape_between($scraped_page, "pid-8915-last", "</td>");
                        $zl_change_per = scrape_between($scraped_page, "pid-8915-pcp", "</td>");
                        $zl_last = substr($zl_last, 2);
                        $zl_change_per = substr($zl_change_per, 3);
                        echo $zl_last; ?>                     
                        <span style="color: <?php echo ($zl_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $zl_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
