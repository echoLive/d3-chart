...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="26.php" class="btn btn-primary btn-xs" role="button">CC</a>        
...
<?php include 'curl_investing.php';
                        $cc_last = scrape_between($scraped_page, "pid-8894-last", "</td>");
                        $cc_change_per = scrape_between($scraped_page, "pid-8894-pcp", "</td>");
                        $cc_last = substr($cc_last, 2);
                        $cc_change_per = substr($cc_change_per, 3);
                        echo $cc_last; ?>                     
                        <span style="color: <?php echo ($cc_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $cc_change_per; ?>
                        </span>                
                    </div>            
                </div>                 
                <div id="chart1">                                                                           
