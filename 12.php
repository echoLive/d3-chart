...
<script src="csmain2.js"></script>           
    ...
    <body>             
        <div id="navbox">                     
            ...
            <a href="12.php" class="btn btn-primary btn-xs" role="button">PL</a>                     
...
<?php include 'curl_investing.php';
                    $pl_last = scrape_between($scraped_page, "pid-8910-last", "</td>");
                    $pl_change_per = scrape_between($scraped_page, "pid-8910-pcp", "</td>");
                    $pl_last = substr($pl_last, 2);
                    $pl_change_per = substr($pl_change_per, 3);
                    echo $pl_last;
                                                                    ?>                                               
                        <span style="color: <?php echo ($pl_change_per < 0 ? 'red' : 'green') ?>">&nbsp;                             
                            <?php echo $pl_change_per; ?>                         
                        </span>                                     
                    </div>                             
                </div>                                 
                <div id="chart1">                                                          
