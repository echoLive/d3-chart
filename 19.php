...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="19.php" class="btn btn-primary btn-xs" role="button">ZC</a>        
...
<?php include 'curl_investing.php';
                    $zc_last = scrape_between($scraped_page, "pid-8918-last", "</td>");
                    $zc_change_per = scrape_between($scraped_page, "pid-8918-pcp", "</td>");
                    $zc_last = substr($zc_last, 2);
                    $zc_change_per = substr($zc_change_per, 3);
                    echo $zc_last;
                                            ?>                     
                        <span style="color: <?php echo ($zc_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $zc_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
