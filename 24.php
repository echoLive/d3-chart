...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="24.php" class="btn btn-primary btn-xs" role="button">ZM</a>        
...
<?php include 'curl_investing.php';
                        $zm_last = scrape_between($scraped_page, "pid-8919-last", "</td>");
                        $zm_change_per = scrape_between($scraped_page, "pid-8919-pcp", "</td>");
                        $zm_last = substr($zm_last, 2);
                        $zm_change_per = substr($zm_change_per, 3);
                        echo $zm_last; ?>                     
                        <span style="color: <?php echo ($zm_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $zm_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
