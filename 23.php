...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="23.php" class="btn btn-primary btn-xs" role="button">ZS</a>        
...
<?php include 'curl_investing.php';
                        $zs_last = scrape_between($scraped_page, "pid-8916-last", "</td>");
                        $zs_change_per = scrape_between($scraped_page, "pid-8916-pcp", "</td>");
                        $zs_last = substr($zs_last, 2);
                        $zs_change_per = substr($zs_change_per, 3);
                        echo $zs_last; ?>                     
                        <span style="color: <?php echo ($zs_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $zs_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
