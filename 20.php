...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="20.php" class="btn btn-primary btn-xs" role="button">ZW</a>        
...
<?php include 'curl_investing.php';
                    $zw_last = scrape_between($scraped_page, "pid-8917-last", "</td>");
                    $zw_change_per = scrape_between($scraped_page, "pid-8917-pcp", "</td>");
                    $zw_last = substr($zw_last, 2);
                    $zw_change_per = substr($zw_change_per, 3);
                    echo $zw_last;
                                            ?>                     
                        <span style="color: <?php echo ($zw_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $zw_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
