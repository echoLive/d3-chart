...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="28.php" class="btn btn-primary btn-xs" role="button">OJ</a>        
...
<?php include 'curl_investing.php';
                        $oj_last = scrape_between($scraped_page, "pid-8891-last", "</td>");
                        $oj_change_per = scrape_between($scraped_page, "pid-8891-pcp", "</td>");
                        $oj_last = substr($oj_last, 2);
                        $oj_change_per = substr($oj_change_per, 3);
                        echo $oj_last; ?>                     
                        <span style="color: <?php echo ($oj_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $oj_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
