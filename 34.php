...
<script src="csmain2.js"></script>          
    ...
    <body>             
        <div id="navbox">                     
            ...
            <a href="34.php" class="btn btn-primary btn-xs" role="button">HE</a>                     
...
<?php include 'curl_investing.php';
                        $he_last = scrape_between($scraped_page, "pid-8913-last", "</td>");
                        $he_change_per = scrape_between($scraped_page, "pid-8913-pcp", "</td>");
                        $he_last = substr($he_last, 2);
                        $he_change_per = substr($he_change_per, 3);
                        echo $he_last; ?>                                               
                        <span style="color: <?php echo ($he_change_per < 0 ? 'red' : 'green') ?>">&nbsp;                             
                            <?php echo $he_change_per; ?>                         
                        </span>                                     
                    </div>                             
                </div>                                 
                <div id="chart1">                                                                                            
