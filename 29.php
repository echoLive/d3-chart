...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="29.php" class="btn btn-primary btn-xs" role="button">KC</a>        
...
<?php include 'curl_investing.php';
                        $kc_last = scrape_between($scraped_page, "pid-8832-last", "</td>");
                        $kc_change_per = scrape_between($scraped_page, "pid-8832-pcp", "</td>");
                        $kc_last = substr($kc_last, 2);
                        $kc_change_per = substr($kc_change_per, 3);
                        echo $kc_last; ?>                     
                        <span style="color: <?php echo ($kc_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $kc_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
