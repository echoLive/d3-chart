...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="17.php" class="btn btn-primary btn-xs" role="button">HO</a>        
...
<?php include 'curl_investing.php'; 
                    $ho_last = scrape_between($scraped_page, "pid-8988-last", "</td>");
                    $ho_change_per = scrape_between($scraped_page, "pid-8988-pcp", "</td>");
                    $ho_last = substr($ho_last, 2);
                    $ho_change_per = substr($ho_change_per, 3);
                    echo $ho_last;
                                            ?>                     
                        <span style="color: <?php echo ($ho_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $ho_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
