...
<script src="csmain2.js"></script>    
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="32.php" class="btn btn-primary btn-xs" role="button">LE</a>        
...
<?php include 'curl_investing.php';
                        $le_last = scrape_between($scraped_page, "pid-8914-last", "</td>");
                        $le_change_per = scrape_between($scraped_page, "pid-8914-pcp", "</td>");
                        $le_last = substr($le_last, 2);
                        $le_change_per = substr($le_change_per, 3);
                        echo $le_last; ?>                     
                        <span style="color: <?php echo ($le_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                            <?php echo $le_change_per; ?>
                        </span>                
                    </div>            
                </div>                
                <div id="chart1">                                                                           
