...
<html>         
    ...
    <body>    
        <div id="navbox">        
            ...
            <a href="11.php" class="btn btn-primary btn-xs" role="button">SI</a>        
        ...
        <div id="demobox">        
            <div id="csbox">            
                ...
                <div id="infobar">                
                    ...
                    $si_last = scrape_between($scraped_page, "pid-8836-last", "</td>");
                    $si_change_per = scrape_between($scraped_page, "pid-8836-pcp", "</td>");
                    $si_last = substr($si_last, 2);
                    $si_change_per = substr($si_change_per, 3);
                    echo $si_last; ?>                     
                    <span style="color: <?php echo ($si_change_per < 0 ? 'red' : 'green') ?>">&nbsp;
                    <?php echo $si_change_per; ?>
                    </span>                
                    </div>            
                </div>            
                <div id="chart1">                                                          
