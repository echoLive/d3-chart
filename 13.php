...
<div id="navbox">
        ...
        <a href="13.php" class="btn btn-primary btn-xs" role="button">PA</a>
        ...
        <a href="30.php" class="btn btn-default btn-xs" role="button">SB</a>
    ...
    <div id="demobox">
        <div id="csbox">
            ...
            <div id="infobar">
                ...
                <div id="infovolume" class="infovol"></div>
                <div id="infocontract" class="infotail"></div>
                <div>Today: 
                    <?php include 'curl_investing.php';
                    $pa_last = scrape_between($scraped_page, "pid-8883-last", "</td>");
                    $pa_change_per = scrape_between($scraped_page, "pid-8883-pcp", "</td>");
                    $pa_last = substr($pa_last, 2);
                    $pa_change_per = substr($pa_change_per, 3);
                    echo $pa_last; ?>
                    <span style="color: <?php echo ($pa_change_per < 0 ? 'red' : 'green') ?>">&nbsp;<?php echo $pa_change_per; ?></span>
                </div>
            </div>
                <div id="chart1">                                                          
                </div>                                                       
